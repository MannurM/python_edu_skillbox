...
def brick_in_hole(hole_x, hole_y, brick_x, brick_y, brick_z):
    ...
    brick_2 = brick_x * brick_z
    brick_3 = brick_y * brick_z
    # TODO Площадь в данном случае не даст правильный ответ.
    # TODO Возьмем крайний случай, когда размер отверстия X равен 1000, а размер отверстия Y равен 1
    # TODO Площадь будет равна 1000, но кирпич с размерами 10х10х10 не влезет в это отверстие
    # TODO как бы его не поворачивали.
    # TODO Поэтому нужно проверить 6 сочетаний сторон, о которых я писал в прошлый раз
    if hole >= brick_1 and hole >= brick_2 and hole >= brick_3:
        print('Да')
